...
class Configuration implements ConfigurationInterface
{
    public function getConfigTreeBuilder(): TreeBuilder
    {
        ...
        $rootNode
            ->children()
                ->append($this->addSourceSection())
                ->append($this->addCacheSection())
                ->append($this->addWatermarksSection())
                ->enumNode('driver')
                    ->values(['gd', 'imagick'])
                    ->defaultValue('gd')
                ->end()
    ...
    private function addSourceSection(): NodeDefinition
    {
    ...
    private function addCacheSection(): NodeDefinition
    {
        $builder = new TreeBuilder('cache');
        $node = $builder->getRootNode();
    ...
    private function addWatermarksSection(): NodeDefinition
    {
        $builder = new TreeBuilder('watermarks');
        $node = $builder->getRootNode();
    ...
    {
        $builder = new TreeBuilder('image_manipulation');
        $node = $builder->getRootNode();
